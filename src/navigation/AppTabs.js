...
// 🔘 Botón personalizado con "ripple" animado
...
export default function AppTabs() {
  ...
  // ✅ Amarillo recomendado (suave, no “marca” tanto como #FFFF00)
  const rippleColor = "rgba(255, 193, 7, 0.45)"; // tipo Amber

  // Si preferís que siga tu tema:
  // const rippleColor = `${theme.colors.primary}33`; // ojo: esto asume hex; si no es hex, usá rgba como arriba
  ...
  return (
    <Tab.Navigator
      screenOptions={{
        ...
        // ✅ acá aplicamos el botón custom a todas las tabs
        tabBarButton: (props) => (
