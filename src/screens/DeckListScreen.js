    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.background }}>
      <DraggableFlatList
        ...
        renderItem={({ item: d, index, getIndex, drag, isActive }) => {
          const i = typeof getIndex === "function" ? getIndex() : index;
          const rank = (Number.isFinite(i) ? i : 0) + 1;
                ...
                <Card.Content style={{ gap: 12, paddingTop: 16, position: "relative" }}>
                  ...
                  <View style={{ flexDirection: "row", gap: 12, alignItems: "center" }}>
                    ...
                    <View style={{ flex: 1, gap: 6, paddingTop: 10 }}>
                      <Text variant="titleLarge" style={{ fontWeight: "900", lineHeight: 26 }} numberOfLines={2}>
                        {d.nombre || "—"}
                      </Text>
        ...
        >
          ...
          <View style={{ padding: 14, gap: 10 }}>
            ...
            >
              ...
              <Text style={{ fontWeight: "900", fontSize: 16 }}>{deleteState.deck?.nombre || "Este deck"}</Text>
            ...
            <View style={{ flexDirection: "row", gap: 10, marginTop: 4 }}>
              <Button mode="outlined" style={{ flex: 1, borderColor: theme.colors.outline }} onPress={closeDelete}>
                Cancelar
              </Button>

              <Button mode="contained" style={{ flex: 1 }} buttonColor={theme.colors.primary} onPress={onDeleteConfirmed}>
                Eliminar
              </Button>
            </View>
          </View>
